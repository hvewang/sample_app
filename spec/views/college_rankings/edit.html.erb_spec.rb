...
describe "college_rankings/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit college_ranking form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => college_ranking_path(@college_ranking), :method => "post" do
