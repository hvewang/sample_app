...
describe "college_lists/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit college_list form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => college_list_path(@college_list), :method => "post" do
