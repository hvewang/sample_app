...
describe "graduate_school_rankings/new.html.erb" do
  before(:each) do
    assign(:graduate_school_ranking, stub_model(GraduateSchoolRanking,
      :category => "MyString",
      :rank => 1,
      :name_en => "MyString",
      :name_cn => "MyString",
  ...
  it "renders new graduate_school_ranking form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => graduate_school_rankings_path, :method => "post" do
