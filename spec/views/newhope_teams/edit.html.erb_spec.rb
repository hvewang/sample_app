...
describe "newhope_teams/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit newhope_team form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => newhope_team_path(@newhope_team), :method => "post" do
