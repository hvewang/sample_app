...
describe "host_family_infos/new.html.erb" do
  before(:each) do
    assign(:host_family_info, stub_model(HostFamilyInfo,
      :f_nm => "MyString",
      :l_nm => "MyString",
      :sex => "MyString",
      :street => "MyString",
  ...
  it "renders new host_family_info form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => host_family_infos_path, :method => "post" do
