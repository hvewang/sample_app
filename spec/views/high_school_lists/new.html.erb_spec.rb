...
describe "high_school_lists/new.html.erb" do
  before(:each) do
    assign(:high_school_list, stub_model(HighSchoolList,
      :name_en => "MyString",
      :name_cn => "MyString",
      :hs_type => "MyString",
      :address => "MyString",
  ...
  it "renders new high_school_list form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => high_school_lists_path, :method => "post" do
