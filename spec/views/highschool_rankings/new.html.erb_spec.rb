...
describe "highschool_rankings/new.html.erb" do
  before(:each) do
    assign(:highschool_ranking, stub_model(HighschoolRanking,
      :year => "MyString",
      :name_en => "MyString",
      :name_cn => "MyString",
      :address => "MyString",
  ...
  it "renders new highschool_ranking form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => highschool_rankings_path, :method => "post" do
